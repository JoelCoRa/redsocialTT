...
@Component({
    ...
    imports: [NavbarComponent, SidebarComponent, TituloSeccionComponent, MsgRecursosComponent, MenurecursosComponent, FooterComponent, MatTableModule, MatPaginatorModule, MatCardModule]
})
